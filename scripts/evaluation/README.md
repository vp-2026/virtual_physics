...
rounds each axis mechanically, never searches for a valid neighboring point,
never projects an invalid result into validity, and never selects the best
perturbation after the fact.
